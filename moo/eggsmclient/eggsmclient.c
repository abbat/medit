...
G_DEFINE_TYPE_WITH_CODE (EggSMClient, egg_sm_client, G_TYPE_OBJECT, G_ADD_PRIVATE(EggSMClient))
...
{
  EggSMClientPrivate *priv = (EggSMClientPrivate*) egg_sm_client_get_instance_private (client);

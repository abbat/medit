...
G_DEFINE_TYPE_WITH_CODE (GtkSourceLanguage, gtk_source_language, G_TYPE_OBJECT, G_ADD_PRIVATE(GtkSourceLanguage))
...
{
	lang->priv = (GtkSourceLanguagePrivate*) gtk_source_language_get_instance_private (lang);

...
typedef enum
{
	GTK_SOURCE_SEARCH_VISIBLE_ONLY		 = 1 << 0, // GTK_TEXT_SEARCH_VISIBLE_ONLY
	GTK_SOURCE_SEARCH_TEXT_ONLY		 = 1 << 1, // GTK_TEXT_SEARCH_TEXT_ONLY
	GTK_SOURCE_SEARCH_CASE_INSENSITIVE	 = 1 << 2, // GTK_TEXT_SEARCH_CASE_INSENSITIVE

...
static const SearchCase search_cases[] = {
    ...
    {"regex-backward-many", "cat cat cat", "c.t", MOO_TEXT_SEARCH_REGEX, TRUE, 11, -1, 8, 11},
    {"regex-backward-many-offset", "cat cat cat", "c.t", MOO_TEXT_SEARCH_REGEX, TRUE, 7, -1, 4, 7},
    {"regex-backward-limit-at-match", "cat cat cat", "c.t", MOO_TEXT_SEARCH_REGEX, TRUE, 11, 8, 8, 11},
    {"regex-backward-limit-inside-last", "cat cat cat", "c.t", MOO_TEXT_SEARCH_REGEX, TRUE, 11, 9, -1, -1},
    {"regex-backward-overlap", "aaaa", "aa", MOO_TEXT_SEARCH_REGEX, TRUE, 4, -1, 2, 4},

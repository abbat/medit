                       ...
                       GParamSpec   *pspec)
{
    ...
    {
        case PROP_LABEL:
            moo_pane_set_label (pane, (MooPaneLabel *) g_value_get_boxed (value));
            break;
        case PROP_PARAMS:
            moo_pane_set_params (pane, (MooPaneParams *) g_value_get_boxed (value));
            break;
                     ...
                     GtkWidget     **icon_widget)
{
    ...
    g_return_val_if_fail ((int) position < 4, NULL);
...
{
    gtk_drag_dest_set (pane->button, (GtkDestDefaults) 0, NULL, 0,
               ...
               MooPaneLabel *label)
{
    ...
    pane = (MooPane *) g_object_new (MOO_TYPE_PANE, (const char*) NULL);
                      ...
                      GdkWindow *pane_window)
{
    ...
    {
        pane->parent = (MooPaned *) parent;
        create_widgets (pane, _moo_paned_get_position ((MooPaned *) parent), pane_window);
...
{
    g_return_val_if_fail (MOO_IS_PANE (pane), NULL);
    return (GtkWidget *) pane->focus_child;
}
...
_moo_pane_detach (MooPane *pane)
{
    ...
    if (pane->focus_child)
        gtk_widget_grab_focus ((GtkWidget *) pane->focus_child);
    else

...
* current release of this fork: 1.3.7
...
* Windows, macOS, the python and lua bindings, the HTML widget and everything
  nothing called were removed: the sources are some 26000 lines smaller than
...
`main` carries the current state and every release is tagged (`v1.3.7`,
`v1.3.6`, ...), so `git checkout v1.3.7` gets the sources of a given release.

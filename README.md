...
* current release of this fork: 1.3.8
...
`main` carries the current state and every release is tagged (`v1.3.8`,
`v1.3.7`, ...), so `git checkout v1.3.8` gets the sources of a given release.

...
* current release of this fork: 1.3.5
...
`main` carries the current state and every release is tagged (`v1.3.5`,
`v1.3.4`, ...), so `git checkout v1.3.5` gets the sources of a given release.

...
* current release of this fork: 1.3.6
...
`main` carries the current state and every release is tagged (`v1.3.6`,
`v1.3.5`, ...), so `git checkout v1.3.6` gets the sources of a given release.

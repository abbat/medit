...
* current release of this fork: 1.3.9
...
`main` carries the current state and every release is tagged (`v1.3.9`,
`v1.3.8`, ...), so `git checkout v1.3.9` gets the sources of a given release.
